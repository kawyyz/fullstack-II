...
Para esta evaluación solo se requiere la vista de front (look & feel de las pantallas), sin conexión a un backend. Por ahora están la vista de inicio de sesión, el listado de museos y la vista de reservas.
